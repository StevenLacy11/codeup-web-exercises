...
// var housePopup = new mapboxgl.Popup()
// 	.setHTML("<p>This is my house</p>")
// 	.addTo(map)
//
// marker.setPopup(housePopup)
//
// housePopup.on("close", function () {
...
// with .setText() it will write out the exact characters you put in to the tag.
...
geocode("600 Navarro St #600, San Antonio, TX 78205", mapboxKey).then(function(results) {
	console.log(results);
})
...
// mapboxKey).then(function(results) {
// 	console.log(results);
// 	map.flyTo(results)
//
//
